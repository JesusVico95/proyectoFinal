...
class SeasonSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $seasons = [
            ...
            ['name' => 'Primavera', 'description' => 'Has escogido la primavera, comprendida entre los meses de Marzo-Junio, para muchos es la mejor estación del año ya que florecen las flores.Es por ello que, no podía faltar tú menú para esta estación.'],
